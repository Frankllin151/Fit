  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="bg-white p-8 rounded-md shadow-md w-96">
       ...
       <a href="/academia/redefinir" className="text-indigo-500 text-sm cursor-pointer">Esqueceu a senha?</a> 
      <a href="/academia/cadastra" className="text-indigo-500 text-sm cursor-pointer">Cadastre</a>
       </div>
      </div>
    </div>
  );
